...
public class Exercise1Test extends ClassicOnlineStore {
    ...
    public void iterateByForEach() {
         ...
         */
        Consumer<Object> consumer = (c) -> nameList.add(c.toString());
        customerIterable.forEach(customer -> consumer.accept(customer.getName()));
    ...
    public void whoHaveNoEInYourName() {
         ...
         */
        Predicate<Object> predicate = (p) -> p.toString().contains("e");
